...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-[#466182] grid place-items-center">
      <div className="flex flex-col items-center gap-10">
        ...
        <button className="bg-[#0398d4] text-white px-5 py-2 rounded-sm text-lg hover: cursor-pointer" onClick={()=>{
          setCounter(0)
        }}>Reset</button>
      </div>
    </div>
